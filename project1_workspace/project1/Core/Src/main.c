...
volatile uint8_t g_lcd_hh = 0;
volatile uint8_t g_lcd_mm = 0;
...
/* Definitions for Weather_Mutex */
osMutexId_t Weather_MutexHandle;
const osMutexAttr_t Weather_Mutex_attributes = {
  .name = "Weather_Mutex"
};
/* USER CODE BEGIN PV */
uint8_t rx2char;
