...
#define Buzzer_Alarm_Pin GPIO_PIN_6
#define Buzzer_Alarm_GPIO_Port GPIOA
#define CAM_EN_Pin GPIO_PIN_7
...
#define Flame_Sensor_Pin GPIO_PIN_4
#define Flame_Sensor_GPIO_Port GPIOB
#define VIB_Sensor_Pin GPIO_PIN_5
#define VIB_Sensor_GPIO_Port GPIOB
